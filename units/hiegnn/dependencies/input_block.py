...
class EdgeDegreeEmbedding(torch.nn.Module):
    ...
    def __init__(
        ...
        self.sphere_channels = sphere_channels  # int
        ...
        # qq: for torch.jit, this should be int(896) instead of tensor(896)
        self.m_0_num_coefficients = int(self.mappingReduced.m_size[0].item())
